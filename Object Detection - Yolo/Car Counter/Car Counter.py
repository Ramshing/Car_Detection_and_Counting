...
cap=cv2.VideoCapture("../videos/Car_video.mp4")
cap.set(3,1280)
cap.set(4, 720)
...
mask = cv2.imread("mask design.png")

#tracker
tracker = Sort(max_age=20,min_hits=3,iou_threshold=0.3)

#line drawing
limits=[100,650,1300,650]
...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if currentClass=="car" or currentClass=="motorbike" or currentClass=="bicycle" and conf>0.30:
    ...
    for results in resultsTracker:
        ...
        cvzone.putTextRect(img, f' {int(id)}', (max(0, x1), max(35, y1)), scale=1,
                           thickness=2, offset=5)
